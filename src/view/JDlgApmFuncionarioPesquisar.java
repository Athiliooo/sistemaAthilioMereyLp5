 ...
 * @author win10
 */
public class JDlgApmFuncionarioPesquisar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTableApmFuncionario = new javax.swing.JTable();
        jBtnApmOk = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        jTableApmFuncionario.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jTableApmFuncionario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgApmFuncionarioPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgApmFuncionarioPesquisar dialog = new JDlgApmFuncionarioPesquisar(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableApmFuncionario;
