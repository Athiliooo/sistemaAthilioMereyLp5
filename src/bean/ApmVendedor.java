...
/**
 * ApmVendedor generated by hbm2java
 */
@Entity
@Table(name="apm_vendedor"
    ,catalog="sistema_athilio"
)
public class ApmVendedor  implements java.io.Serializable {


     private int apmIdVendedor;
    ...
    public ApmVendedor(int apmIdVendedor, String apmNome, String apmApelido, String apmCpf, String apmDataNascimento, String apmSenha, int apmNivel, char apmAtivo) {
       this.apmIdVendedor = apmIdVendedor;
    ...
    @Column(name="apm_idVendedor", unique=true, nullable=false)
    public int getApmIdVendedor() {
        return this.apmIdVendedor;
    }
    
    public void setApmIdVendedor(int apmIdVendedor) {
        this.apmIdVendedor = apmIdVendedor;
    }
